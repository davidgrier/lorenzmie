...
;
; CALLING SEQUENCE:
;    field = spherefield(x, y, z, ap, np, nm, lambda, mpp)
;
; INPUTS:
...
;
;    gpu: If set, use GPU_SPHERICALFIELD to compute series of 
...
; 10/15/2012 DGG Updated parameter syntax.  Added usage message and
;    parameter checking
;
; Copyright (c) 2006-2012, Bo Sun and David G. Grier.
;-

function spherefield, x, y, z, a, np, nm, lambda, mpp, $
...
k = 2.d * !dpi / lambda_m       ; wavenumber in medium [pixel^{-1}]
